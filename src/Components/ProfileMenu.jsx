...
const ProfileMenu = ({ profileOpen }) => {
  ...
  return (
    <div
      className={`flex-col absolute right-12 top-0 min-w-70 overflow-y-auto max-h-screen scrollbar-none w-48  rounded-xl shadow-lg z-10 ${
        profileOpen ? "flex" : "hidden"
      } ${
        theme === "dark" ? "bg-[rgba(40,40,40,255)]  text-white " : "bg-white text-black"
      }`}
    >
      <div className="flex items-center p-4 border-b-2 border-white w-full">
        ...
        <div className="flex flex-col ml-2">
          <p className="   font-bold">Arun Neupane</p>
      ...
      <div className="flex items-center gap-3 p-0 pl-4 w-full cursor-pointer hover:bg-[rgba(255,255,255,0.25)]">
        ...
        <span className="   p-2 text-sm">Google Account</span>
      </div>
      <div className="flex items-center gap-3 p-0 pl-4 w-full cursor-pointer hover:bg-[rgba(255,255,255,0.25)]">
        <MdOutlineSwitchAccount style={{ fontSize: "20px" }} />
        <span className="   p-2 text-sm flex justify-between w-full h-full items-center">
      ...
      <div className="flex items-center gap-3 p-0 pl-4 w-full cursor-pointer border-b-1 border-white hover:bg-[rgba(255,255,255,0.25)]">
        ...
        <span className="   p-2 text-sm">Sign Out</span>
      </div>
      <div className="flex items-center gap-3 p-0 pl-4 w-full cursor-pointer hover:bg-[rgba(255,255,255,0.25)]">
        <SiYoutubestudio style={{ fontSize: "20px" }} />
        <span className="   p-2 text-sm">Youtube Studio</span>
      </div>
      <div className="flex items-center gap-3 p-0 pl-4 border-white border-b-1 w-full cursor-pointer hover:bg-[rgba(255,255,255,0.25)]">
        ...
        <span className="   p-2 text-sm">Purchase and Membership</span>
      </div>
      <div className="flex items-center gap-3 p-0 pl-4 w-full cursor-pointer hover:bg-[rgba(255,255,255,0.25)]">
        <RiShieldUserLine style={{ fontSize: "20px" }} />
        <span className="   p-2 text-sm">Your data in YouTube</span>
      </div>
      <div>
        <div
          onClick={toggleTheme}
      ...
      <div className="flex items-center gap-3 p-0 pl-4 border-white border-b-1 w-full cursor-pointer hover:bg-[rgba(255,255,255,0.25)]">
        ...
        <span className="   p-2 text-sm">Keyboard Shortcuts</span>
      </div>
      <div className="flex items-center gap-3 p-0 pl-4 border-white border-b-1 w-full cursor-pointer hover:bg-[rgba(255,255,255,0.25)]">
        <IoSettingsOutline style={{ fontSize: "20px" }} />
        <span className="   p-2 text-sm">Settings</span>
      </div>
      <div className="flex items-center gap-3 p-0 pl-4 w-full cursor-pointer hover:bg-[rgba(255,255,255,0.25)]">
        <IoHelpCircleOutline style={{ fontSize: "20px" }} />
        <span className="   p-2 text-sm">Help</span>
      </div>
      <div className="flex items-center gap-3 p-0 pl-4 w-full cursor-pointer hover:bg-[rgba(255,255,255,0.25)]">
        <MdOutlineFeedback style={{ fontSize: "20px" }} />
        <span className="   p-2 text-sm">Send Feedback</span>
      </div>
    </div>
  );
};
